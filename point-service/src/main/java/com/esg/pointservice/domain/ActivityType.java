...
public enum ActivityType {
  TUMBLER(
    ...
    List.of("tumbler", "reusable", "mug", "thermos", "flask", "water_bottle"),
  ...
  TRANSPORT(
    // ✅ 긍정: 대중교통 및 자전거 관련 단어
    List.of("bus", "bus_stop", "train", "subway", "subway_station", "metro", "railway", "bicycle"),
    // 🚨 부정: 개인 승용차, 운전, 택시
  ...
  RECYCLE(
    ...
    List.of("recycling", "recycling_bin", "sorting", "waste_container", "crushed"),
