package com.esg.communityservice.kafka.config;
...
public class KafkaConsumerConfig {
  ...
  @Bean
  public DefaultErrorHandler errorHandler(KafkaTemplate<String, PostCreatedEvent> template) {
    // 2초 간격으로 최대 3회 재시도
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, PostCreatedEvent> kafkaListenerContainerFactory(ConsumerFactory<String, PostCreatedEvent> consumerFactory,
