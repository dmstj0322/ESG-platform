                            ...
                            {navItems.map(({ to, label, icon: Icon, matchPrefix }) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {label}
                                        {active && (
                                            <span className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-0.5 bg-[#339af0] rounded-full" />
                                        )}
                                    </Link>
                                );
                            })}
                ...
                <div className="flex items-center gap-3">
                      ...
                      {points.toLocaleString()}P
                                    ...
                                    <div className="relative flex items-center" ref={notificationRef}>
                                        <button
                                            ...
                                            className="relative p-1.5 text-gray-500 hover:text-gray-800 hover:bg-gray-100 rounded-lg transition-colors duration-150"
                                        >
                                            <Bell size={18} />
                                            {hasUnread && (
                    ...
                    {user?.name || '내 계정'}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Link
                                to="/signup"
                                className="px-3.5 py-1.5 bg-[#339af0] text-white text-[13px] font-semibold rounded-lg hover:bg-[#0062b3] no-underline transition-all duration-150 shadow-sm shadow-blue-200"
                            >
                                회원가입
                            </Link>
                        </div>
