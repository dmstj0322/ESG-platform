...
${p}` : p;
				...
				if (this.lexer.state.top = !0, this.lexer.blockTokens(p, i, !0), this.lexer.state.top = d, n.length === 0) break;
				let h = i.at(-1);
			...
			for (let a of r.items) {
				if (this.lexer.state.top = !1, a.tokens = this.lexer.blockTokens(a.text, []), a.task) {
					...
					if (c) {
						...
						a.checked = p.checked, r.loose ? a.tokens[0] && ["paragraph", "text"].includes(a.tokens[0].type) && "tokens" in a.tokens[0] && a.tokens[0].tokens ? (a.tokens[0].raw = p.raw + a.tokens[0].raw, a.tokens[0].text = p.raw + a.tokens[0].text, a.tokens[0].tokens.unshift(p)) : a.tokens.unshift({
							type: "paragraph",
							raw: p.raw,
							text: p.raw,
							tokens: [p]
				...
				for (let i in n.hooks) {
					...
					P.passThroughHooks.has(i) ? r[o] = (c) => {
						...
						if (this.defaults.async) return (async () => {
							...
							return d === !1 && (d = await a.apply(r, c)), d;
						})();
						let p = u.apply(r, c);
						return p === !1 && (p = a.apply(r, c)), p;
					};
...
g.Hooks = P;
g.parse = g;
var jt = g.options, Ft = g.setOptions, Ut = g.use, Kt = g.walkTokens, Wt = g.parseInline, Xt = g, Jt = b.parse, Vt = x.lex;
//#endregion
export { P as Hooks, x as Lexer, D as Marked, b as Parser, y as Renderer, L as TextRenderer, w as Tokenizer, T as defaults, z as getDefaults, Vt as lexer, g as marked, jt as options, Xt as parse, Wt as parseInline, Jt as parser, Ft as setOptions, Ut as use, Kt as walkTokens };
