...
public class EvidenceResult {
    ...
    private final boolean isValidEvidence;   // finalScore >= ReportRagService.EVIDENCE_THRESHOLD (filter 통과 보장)
    private final int     retrievalRank;     // finalScore 내림차순 1-based 순위 (retrieveEvidenceForIndicator에서 부여)
    private final String  indicatorCode;     // e.g. "S-201" — confidence 계산·evidence mapping·UI table용
