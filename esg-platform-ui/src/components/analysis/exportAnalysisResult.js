...
const ALL_INDICATOR_CODES_PDF = {
  ...
  'E-104': '폐기물 발생량', 'E-105': '수자원 사용량',
  'S-201': '산업안전 교육 여부', 'S-202': '산업재해 발생 여부', 'S-203': 'ESG 교육 실시 여부',
  'S-204': '임직원 참여율',   'S-205': '지역사회 봉사활동 여부',
  'G-301': '윤리경영 정책 존재 여부', 'G-302': '내부 신고 시스템 여부', 'G-303': 'ESG 담당 조직 존재 여부',
  'G-304': '외부 감사 수행 여부', 'G-305': '이사회 독립성 정책 여부',
};
